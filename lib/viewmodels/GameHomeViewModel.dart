...
class GameHomeViewModel extends ChangeNotifier {
  ...
  Future<void> fetchTeamMembers(String teamAId, String teamBId) async {
    ...
    notifyListeners();
    try {
      final teamARes = await http.get(Uri.parse('${Config.apiBaseUrl}/team/members?teamId=$teamAId'));
      final teamBRes = await http.get(Uri.parse('${Config.apiBaseUrl}/team/members?teamId=$teamBId'));
